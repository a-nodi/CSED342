...
solution_exist = True  # FUCK OFF this is true ok?
...
def add_parts_2a(grader, submission):
    ...
    def t_2a_3():
        ...
        if solution_exist:
            grader.requireIsEqual(solution1, 50)
            grader.requireIsEqual(solution2, 70)
    
    grader.addBasicPart('2a-3-hidden', t_2a_3, maxPoints=1, maxSeconds=1, description='hidden test case where UCS becomes inefficient')
...
def add_parts_2b(grader, submission):
    ...
    grader.addBasicPart('2b-2-hidden', t_2b_2, maxPoints=3, maxSeconds=3, description='hidden test case for maze search with A*')
    ...
    grader.addBasicPart('2b-3-hidden', t_2b_3, maxPoints=4, maxSeconds=3, description='hidden test case for maze search with A*, where UCS becomes inefficient')
    ...
    grader.addBasicPart('2b-4-hidden', t_2b_4, maxPoints=4, maxSeconds=3, description='hidden test case for modified maze search with A*, where UCS becomes inefficient')
